...
export function supportsExtendedKeys(): boolean {
  // coda override: keep legacy keypress encoding. coda's input layer
  // (useTextInput/keybindings) was written against stock-Ink semantics where
  // Ctrl+C arrives as raw \x03 — kitty/modifyOtherKeys re-encode it as a CSI-u
  // sequence, which breaks Ctrl+C exit and other Ctrl+<key> handling.
  return false
}
