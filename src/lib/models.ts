...
export const modelOptions: ModelOption[] = [
  ...
  { id: 12, label: 'gpt-6-astra-low', name: 'gpt-6-astra', provider: 'openai', effort: 'low', contextWindow: 1050000 },
  { id: 13, label: 'gpt-6-astra-medium', name: 'gpt-6-astra', provider: 'openai', effort: 'medium', contextWindow: 1050000 },
  { id: 14, label: 'gpt-6-astra-high', name: 'gpt-6-astra', provider: 'openai', effort: 'high', contextWindow: 1050000 },
  { id: 15, label: 'gpt-6-astra-xhigh', name: 'gpt-6-astra', provider: 'openai', effort: 'xhigh', contextWindow: 1050000 },
  { id: 16, label: 'gpt-6-astra-max', name: 'gpt-6-astra', provider: 'openai', effort: 'max', contextWindow: 1050000 },
];
