...
const dark: Theme = {
  brand: 'rgb(127,200,255)',
  brandDim: 'rgb(64,102,141)',
  text: 'rgb(242,250,255)',
  inverseText: 'rgb(3,7,16)',
  subtle: 'rgb(64,102,141)',
  inactive: 'rgb(153,211,255)',
  suggestion: 'rgb(178,222,255)',
  permission: 'rgb(127,200,255)',
  planMode: 'rgb(227,255,143)',
  bashBorder: 'rgb(199,142,173)',
  promptBorder: 'rgb(47,75,104)',
  success: 'rgb(227,255,143)',
  error: 'rgb(251,176,165)',
  warning: 'rgb(248,232,230)',
  diffAdded: 'rgb(46,57,0)',
  diffRemoved: 'rgb(99,70,67)',
  diffAddedDimmed: 'rgb(47,75,104)',
...
const light: Theme = {
  ...
  subtle: 'rgb(64,102,141)',
  inactive: 'rgb(47,75,104)',
  suggestion: 'rgb(0,109,221)',
  permission: 'rgb(0,109,221)',
  planMode: 'rgb(110,137,0)',
  bashBorder: 'rgb(136,82,112)',
  promptBorder: 'rgb(178,222,255)',
  success: 'rgb(110,137,0)',
  error: 'rgb(178,125,117)',
